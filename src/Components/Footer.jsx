...
function Footer() {
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <p className="mt-4 text-gray-400 text-sm">
            A 3-month immersive program in Janakpur to learn Artificial
            Intelligence, Machine Learning, and Deep Learning with hands-on
 ...
 <Link to="/aisummit/sponsor">
              <div className="hover:text-blue-400">AI Summit</div>
            </Link>
            <li>
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            📧 janakpurtechbootcamp@gmail.com
          </p>
          ...
          <div className="flex space-x-4 mt-4">
            ...
            <a
              href="mailto:info@aibootcamp.com"
