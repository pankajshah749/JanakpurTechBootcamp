...
function FeedbackCard({ item }) {
  return (
    <div className="bg-white rounded-xl shadow-md p-5 w-80 min-w-[18rem] flex-shrink-0">
      <img
        src={item.image}
        alt={item.name}
      ...
      <p className="text-sm text-center text-gray-500">{item.role}</p>
       <p className="text-gray-700 italic mb-3 text-sm leading-snug">“{item.feedback}”</p>
    </div>
  );
}

export default function Feedback() {
  // duplicate arrays so marquee is continuous
    ...
    <section className="bg-gray-50 py-16 overflow-hidden">
      ...
      <style>{`
        .marquee {
          ...
          gap: 1rem;
          align-items: center;
          /* will be animated by inline style for duration */
        }
        @keyframes marquee-left {
          0% { transform: translateX(0); }
          100% { transform: translateX(-50%); } /* moves half (since items duplicated) */
        }
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mb-10">
          <h3 className="text-2xl font-semibold text-blue-800 mb-4 text-center">Web Development</h3>

          <div
            className="marquee-track overflow-hidden"
            role="region"
            aria-label="Web development student testimonials"
          >
            <div
              className="marquee"
              style={{
                animation: `marquee-left 18s linear infinite`,
                // you can tweak duration above (18s) to speed up/slower
              }}
            >
        ...
        {/* Data Science Track */}
        <div>
          <h3 className="text-2xl font-semibold text-blue-800 mb-4 text-center">Data Science</h3>

          <div
            className="marquee-track overflow-hidden"
            role="region"
            aria-label="Data science student testimonials"
          >
            <div
              className="marquee"
              style={{
